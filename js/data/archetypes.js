...
const ARCHETYPE_DATA = {
  ...
  fun_haver: { name: 'The Fun Haver', perk: 'Main Character Energy', desc: 'Bad scientist, great friend. Bonds gains 1.5x, Research gains cut 25%.', st: { mind: 50, body: 58, wallet: 50, bonds: 70, research: 35 } },
